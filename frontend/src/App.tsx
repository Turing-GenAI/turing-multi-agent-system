    ...
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      <div className="flex-1">
        <Routes>
          ...
          <Route path="/compliance/review/:reviewId" element={
            <ProtectedRoute>
      ...
      {/* 
        Only render the Footer if not on the AuditPage, LoginPage, or CompliancePage
        ...
        in the AuditPage component. CompliancePage also has complex scrollable content.
      */}
      {!isAuditPage && !isLoginPage && !isCompliancePage && <Footer />}
    </div>
  );
};
