...
export const InformationCollection: React.FC<InformationCollectionProps> = ({ onInformationSubmit }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // For now, don't navigate anywhere
    // navigate('/compliance');
  };
  ...
  return (
    <div className="flex h-full">
      ...
      <div className="flex-1 flex justify-center overflow-auto py-10 px-6">
        <div className="w-full max-w-6xl flex">
          {/* Form Section */}
          <div className="flex-1 pr-10">
            <h2 className="text-2xl font-semibold mb-8">Trial Information Collection</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="pt-6">
                <button
                  type="submit"
                  className="w-full px-4 py-3 bg-black text-white rounded-md hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-black focus:ring-offset-2 transition-colors duration-200 font-medium"
                >
                  Submit & Start Review
                </button>
              </div>
          ...
          <div className="w-80 bg-gray-50 p-6 rounded-lg border border-gray-200 h-fit">
