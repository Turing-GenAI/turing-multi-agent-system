...
class inspectionNodes:
    ...
    def interrupt_for_planner_feedback(self, state: InspectionAgentState):
        ...
        if FEEDBACK_FOR_PLANNER:
            ...
            # })
            return {"final_sub_activities": result["final_sub_activities"]}
        else:
            feedback = "y"
            return {
                "feedback_from": "planner_user_validation",
    ...
    #     if FEEDBACK_FOR_PLANNER:
    #         logger.debug("Interrupting for planner feedback...")

    #         # Trigger an interrupt every time
    #         return Command({
    #             "interrupt": {
    #                 "task": "Review the sub-activities generated by the LLM and make any necessary changes.",
    #                 "final_sub_activities": state["final_sub_activities"],
    #                 "resume": "interrupt_for_planner_feedback"
    #             }
    #         })

    #     # If feedback is disabled, continue execution
    #     feedback = "y"
    #     return {
    #         "feedback_from": "planner_user_validation",
    #         "feedback": feedback,
